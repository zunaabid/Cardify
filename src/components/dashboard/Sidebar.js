...
function Sidebar({ activeTab, onTabChange, onCreateNew }) {
  ...
  return (
    <div className={`sidebar ${expanded ? "expanded" : "collapsed"}`}>
      <div className="sidebar-header">
        <div className="sidebar-logo">{expanded ? <h1>Cardify</h1> : <div className="logo-icon">C</div>}</div>
